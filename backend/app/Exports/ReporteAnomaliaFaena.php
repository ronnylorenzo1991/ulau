...
class ReporteAnomaliaFaena implements FromCollection,WithHeadings,ShouldAutoSize,WithEvents
{
    public $id;
    ...
    public function collection()
    {
        ...
        if($this->id == 0){
            ...
            $siIP = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                    ...
                                    ->where('servicio_id', 2)
                                    ->count();
            $generalIP = Tarea::where('tareas.dia_operativo', 'Si')
                                    ->where('servicio_id', 2)
                                    ->count();
            $noIP = Tarea::where('tareas.dia_operativo', 'No')
                                ->where('servicio_id', 2)
                                ->count();
            ...
            $siISLU = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                    ...
                                    ->where('servicio_id', 3)
                                    ->count();
            $generalISLU = Tarea::where('tareas.dia_operativo', 'Si')
                                    ->where('servicio_id', 3)
                                    ->count();
            $noISLU = Tarea::where('tareas.dia_operativo', 'No')
                                    ->where('servicio_id', 3)
                                    ->count();
            ...
            $siIRL = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                        ...
                                        ->where('servicio_id', 4)
                                        ->count();
            $generalIRL = Tarea::where('tareas.dia_operativo', 'Si')
                                        ->where('servicio_id', 4)
                                        ->count();
            $noIRL = Tarea::where('tareas.dia_operativo', 'No')
                                    ->where('servicio_id', 4)
                                    ->count();
            ...
            $siITF = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                        ...
                                        ->where('servicio_id', 5)
                                        ->count();
            $generalITF = Tarea::where('tareas.dia_operativo', 'Si')
                                        ->where('servicio_id', 5)
                                        ->count();
            $noITF = Tarea::where('tareas.dia_operativo', 'No')
                                    ->where('servicio_id', 5)
                                    ->count();
            ...
            $siILF = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                        ...
                                        ->where('servicio_id', 6)
                                        ->count();
            $generalILF = Tarea::where('tareas.dia_operativo', 'Si')
                                        ->where('servicio_id', 6)
                                        ->count();
            $noILF = Tarea::where('tareas.dia_operativo', 'No')
                                    ->where('servicio_id', 6)
                                    ->count();
            ...
            $siIFM = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                        ...
                                        ->where('servicio_id', 7)
                                        ->count();
            $generalIFM = Tarea::where('tareas.dia_operativo', 'Si')
                                        ->where('servicio_id', 7)
                                        ->count();
            $noIFM = Tarea::where('tareas.dia_operativo', 'No')
                                    ->where('servicio_id', 7)
                                    ->count();
            ...
            $siOS = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                    ...
                                    ->where('servicio_id', 8)
                                    ->count();
            $generalOS = Tarea::where('tareas.dia_operativo', 'Si')
                                    ->where('servicio_id', 8)
                                    ->count();
            $noOS = Tarea::where('tareas.dia_operativo', 'No')
                                    ->where('servicio_id', 8)
                                    ->count();
        } else {
            $siEM = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                        ...
                                        ->where('servicio_id', 1)
                                        ->count();
            $generalEM = Tarea::where('tareas.centros_id', $this->id)
                                        ->where('tareas.dia_operativo', 'Si')
                                        ->where('servicio_id', 1)
                                        ->count();
            $noEM = Tarea::where('tareas.dia_operativo', 'No')
                                    ->where('servicio_id', 1)
                                    ->count();
            ...
            $siIP = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                    ...
                                    ->where('servicio_id', 2)
                                    ->count();
            $generalIP = Tarea::where('tareas.centros_id', $this->id)
                                    ->where('tareas.dia_operativo', 'Si')
                                    ->where('servicio_id', 2)
                                    ->count();
            $noIP = Tarea::where('tareas.dia_operativo', 'No')
            ...
            $siIRL = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                        ...
                                        ->where('servicio_id', 4)
                                        ->count();
            $generalIRL = Tarea::where('tareas.centros_id', $this->id)
                                        ->where('tareas.dia_operativo', 'Si')
                                        ->where('servicio_id', 4)
                                        ->count();
            $noIRL = Tarea::where('tareas.dia_operativo', 'No')
            ...
            $siOS = AnomaliaDetectada::join('tareas', 'tareas.id', '=', 'anomalias_detectadas.tarea_id')
                                    ...
                                    ->where('servicio_id', 8)
                                    ->count();
            $generalOS = Tarea::where('tareas.centros_id', $this->id)
                                    ->where('tareas.dia_operativo', 'Si')
                                    ->where('servicio_id', 8)
                                    ->count();
            $noOS = Tarea::where('tareas.dia_operativo', 'No')

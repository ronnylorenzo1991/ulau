...
class ReporteResumenServicioTodo implements FromCollection,WithHeadings,ShouldAutoSize,WithEvents
{
    public $fecha_inicio;
    public $fecha_fin;
    public $id;
    ...
    */
    public function collection()
    {
        ...
        $centros = Centro::select('id','nombre')->get();
            ...
            array_push($arreglo, [$centros[0]->nombre, $RCA, $SI, $General, $Servicios, '',$centros[0]->nombre, $EM, $IP, $ISLU, $IRL, $ITF, $ILF, $IFM, $OS, $DayEM, $DayIP, $DayISLU, $DayIRL, $DayITF, $DayILF, $DayIFM, $DayOS]);

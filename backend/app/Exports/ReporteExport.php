...
class ReporteExport implements FromCollection,WithHeadings,ShouldAutoSize,WithEvents
{
    public $id;
    ...
    public function collection()
    {
        if($this->id == 0){
            $reporte = DB::table('tareas')
                    ...
                    ->Join('anomalias_detectadas', 'anomalias_detectadas.tarea_id', '=', 'tareas.id')
                    ...
                    ->Join('tipos_anomalias', 'tipos_anomalias.id', '=', 'anomalias_detectadas.tipo_anomalia_id')
                    ->Join('anomalias', 'anomalias.id', '=', 'anomalias_detectadas.anomalia_id')

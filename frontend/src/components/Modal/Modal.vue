            ...
            <div class="fixed inset-0 z-10 overflow-y-auto ">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            class="relative transform rounded-lg bg-white text-left shadow-xl transition-all my-8 w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark" :class="sizeClass">
                            <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900 py-4 pl-10 bg-gray-100">
                                {{ title }}
                            </DialogTitle>
                            <div class="px-4 pb-4 pt-5 sm:p-6 sm:pb-4 border-b border-stroke py-4 px-6.5 dark:border-strokedark">
                            ...
                            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6" v-if="!hiddenFooter">
                                <slot name="footer">
                                    ...
                                    <button type="button"
                                            ...
                                            :disabled="acceptButtonDisabled" :class="acceptButtonDisabled?'bg-gray-500':'bg-primary hover:bg-opacity-90'"
